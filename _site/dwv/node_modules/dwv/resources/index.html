...
<meta name="description" content="Resources ========= * `doc`: dwv doc resources. * `module`: javascript module scripts. * `scripts`: apps and update scripts.">
<meta name="keywords" content="Jekyll, NexT">
<meta property="og:type" content="website">
<meta property="og:title" content="Resources">
<meta property="og:url" content="http://localhost:4000/dwv/node_modules/dwv/resources/">
<meta property="og:site_name" content="scienceasdf">
<meta property="og:description" content="Resources ========= * `doc`: dwv doc resources. * `module`: javascript module scripts. * `scripts`: apps and update scripts.">
<meta property="og:locale" content="zh-Hans">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="Resources">
<meta name="twitter:description" content="Resources ========= * `doc`: dwv doc resources. * `module`: javascript module scripts. * `scripts`: apps and update scripts.">
...
<header class="post-header">
	...
	<h1 class="post-title" itemprop="name headline">Resources</h1>
...
<ul>
  <li><code class="highlighter-rouge">doc</code>: dwv doc resources.</li>
  <li><code class="highlighter-rouge">module</code>: javascript module scripts.</li>
  <li><code class="highlighter-rouge">scripts</code>: apps and update scripts.</li>
</ul>
